...
/**
 * Class ContentDownloadarchiveZip
 * Front end content element "downloadarchive_zip".
 *  
 * @package downloadarchive_zip
 */
class ContentDownloadarchiveZip extends ContentDownloadarchiv
{
  ...
  protected $infoIcon = 'system/modules/downloadarchive_zip/html/dialog-info.png';
	 ...
	 * @var string
	 */
	protected $strTemplate = 'ce_downloadarchive_zip';
